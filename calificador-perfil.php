...
<body>
    ...
    <div class="main-wrapper">
        ...
        pintar_sidebar("calificador-perfil");
        ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title">Perfil Calificador</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Calificador</a></li>
                                <li class="breadcrumb-item active">Perfil Calificador</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="profile-view">
                                    <div class="profile-img-wrap">
                                        <div class="profile-img">
                                            <a href="#"><img alt="" src="assets/img/profiles/avatar-16.jpg"></a>
                                        </div>
                                    </div>
