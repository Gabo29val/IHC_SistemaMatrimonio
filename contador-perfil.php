...
<body>
    ...
    <div class="main-wrapper">
        ...
        pintar_sidebar("contador-perfil");
        ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="page-title">Perfil Contador</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Contador</a></li>
                                <li class="breadcrumb-item active">Perfil Contador</li>
                            </ul>
                        </div>
                    </div>
                </div>
