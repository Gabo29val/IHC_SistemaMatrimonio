                ...
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a class="<?php if ($select === "calificador-perfil") {
                                                echo "active";
                                            } ?>" href="calificador-perfil.php">Perfil Calificador</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="submenu">
                        <a href="#"><i class="las la-calendar-check"></i> <span> Expedientes </span> <span class="menu-arrow"></span></a>
                        <ul style="display: none;">
                            <li><a class="<?php if ($select === "calificador-expedientes-lista") {
                                                echo "active";
                                            } ?>" href="calificador-expedientes-lista.php"><i class="las la-list-ol"></i><span style="margin-left: 10px;">Mostrar expedientes</span></a></li>
                            <li><a class="<?php if ($select === "calificador-expedientes-registrar") {
                                                echo "active";
                                            } ?>" href="calificador-expedientes-registrar.php"><i class="la la-edit"></i><span style="margin-left: 10px;">Registrar nuevo expediente</span></a></li>
                        </ul>
                    </li>
                    <!--
                    <li class="submenu">
